...
let  randomNumber = Math.floor(Math.random() * maximumNumber);
...
let predefinedguesses = [45,35,75,85,254,75,25,86,99,5,23,5,2,3,76,76,887,54,1,6,8,66,32,9,65,35,86,6,87,67,56,43,47,49,598,90,12,131,5,16,44,33,56,76];
